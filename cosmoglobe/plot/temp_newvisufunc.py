...
import numpy as np
from healpy.pixelfunc import ang2pix, npix2nside, remove_dipole, remove_monopole
from healpy.rotator import Rotator, coordsys2euler_zyz
...
from healpy.projaxes import LogNorm2, HistEqNorm, LinNorm2
